...
const PhotoBlogCard = ({props, count}) => {
    return (
        ...
        <Card id = "photoCard" style = {{background:"rgb(31, 31, 31)" }}>
            ...
            <span className="film-wrapper">
                <span className="gi-num kodak-text-tweaks">{count}</span>
                    <span className="grid-title title-glow kodak-text-tweaks">
            ...
            <div className="photo-label">
                <Card.Text className="footer grid-title">{props.featuredImage.name}</Card.Text>
                <Card.Text className="footer grid-title">{props.date}</Card.Text>
            </div>
        </Card>
