    ...
    return (
        <div>
            ...
            <LineChart data={DodgersTickets}>
                <Line type="monotone" dataKey={metric} stroke={teamStyles[team].color} name = "% diff"/>
                ...
                <YAxis dataKey = {metric} label = {{value : "Difference from initial \n listed Price", angle : -90, dx: -20, fontFamily: 'halyard-display, sans-serif'}} width = {60} tickCount = {3} type = "number" fontSize = {15} fontFamily = {'halyard-display, sans-serif'} ticks = {metric === "diff_initial" ? [-50, 0, 50] : [0, 25, 50, 75]}/>
