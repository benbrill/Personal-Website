...
description: "PocketPatron is the first theater centric traking and ranking app. It allows user to diary their theater visits and rank shows against each other"
url: pocket_patron
sort_index: -1
---
