    ...
    return (
      <MediaContextProvider>
        ...
        <Nav className="justify-content right" >
          ...
          <Nav.Link href="/design" style={{ transition: '1s ease', color: 'white'}}>Design</Nav.Link>
        ...
        <Nav className="justify-content right" >
          ...
          <Nav.Link href="/design" style={{ transition: '1s ease', color: navBackground ? '#2b2b2b' : 'white'}}>Design</Nav.Link>
